...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "goals, etc.\n"
        "    1b. IMMEDIATELY call suggest_system_prompt with their one-sentence "
        "description as use_case and a 3-4 sentence starting system prompt that "
        "captures what they said. Say ONE short line: 'I dropped a starting prompt "
        "in the side panel — copy that into the System Prompt field and pick a "
