...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "🛑 ABSOLUTE RULE — TOOL CALL ENDS YOUR TURN. After you call ANY tool "
        "(suggest_system_prompt, show_suggestions, ask_feature_question, "
        "tutor_step, create_persona_for_me, etc.), generate ZERO additional "
        "text in the SAME response. The tool call is the LAST thing in your "
        "output. Stop. Wait for the user's next message. If you're tempted to "
        "explain what just appeared in the panel, THAT is the double "
        "acknowledgment showing up — STOP. The card is visual; the user can "
        "read it. Anything you say after the tool call in the same response "
        "is the second echo. So your response is EITHER (a) 1-3 words + tool "
        "call + STOP, OR (b) ONE transition sentence + STOP. NEVER speech, "
        "then tool, then more speech in one response.\n"
        ...
        "because.\n"
        "⚠️ DO NOT 'research before asking.' You already know every Tavus "
        "feature. You do not need to call search_tavus_docs to look up "
        "Objectives, Knowledge Base, Guardrails, etc. before asking the user "
        "about them. Call ask_feature_question DIRECTLY with the question you "
        "want to ask. If you find yourself about to fire search_tavus_docs "
        "during the consultation to 'learn about a feature' — STOP. Just call "
        "ask_feature_question with your best tailored question and options. "
