...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "they might say 'I don't need that' / 'I'll do it later' / 'skip'). Affirm "
        "in ONE short line either way — 'Good, that's the playbook for that' if "
        "they picked, or 'All good, that's a later thing' if they skipped — and "
        "move to the next feature. Never push when they skip. Every feature is "
        "opt-in.\n"
        "    After all six (or however many they engaged with), ONE wrap line: "
        "'OK — that's the design. You can wire any of these later in the Layers "
