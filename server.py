...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "(naturally — they might say 'first one' or describe their own choice). "
        "Affirm in ONE short line ('Good — that's the playbook for that') and move "
        "to the next feature.\n"
        "    After all six, ONE wrap line: 'OK — that's the design. You can wire "
        "any of these later in the Layers panel; defaults are fine today.'\n"
