...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "what you suggested). Skip features they opted out of. The panel now "
        "paints: what they covered ✓, their actual design decisions ✓, and what "
        "to explore next ☐ with doc links. Say ONE line: 'Here's where we "
        "landed, and the parts you haven't touched yet — each of those is what "
        "takes a chatbot with a face into something that feels alive.' Then ASK "
        "if they want time with a human to go deeper. ONLY call offer_calendar "
        "if they affirm. Do not push it.\n"
