...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "answer (example: KB + 'they need to know our product' → "
        "show_suggestions('Knowledge Base', 'Here's what to upload for that:', "
        "['PowerPoint decks', 'Product PDFs and brochures', 'Customer call "
        "transcripts', 'Internal product wiki'])). Then ONE short transitional "
        "line — 'These live in the dashboard whenever' or 'Save those for after' "
        "— that does NOT list the items on the card. Then move to next feature.\n"
