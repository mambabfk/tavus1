...
CONTEXTS = {
    ...
    "tutor": (
        ...
        "    1a. Ask in ONE short sentence for a ONE-WORD use case: 'Give me one "
        "word — what kind of agent? Sales, tutor, support, interviewer, fitness, "
        "anything.' Accept the first answer; do NOT ask follow-ups about audience, "
        "tone, goals, etc.\n"
        "    1b. IMMEDIATELY call suggest_system_prompt with that use_case and a "
        "3-4 sentence starting system prompt for it. Say ONE short line: 'I dropped "
        "a starting prompt in the side panel — copy that into the System Prompt "
        "field and a name for your persona.'\n"
