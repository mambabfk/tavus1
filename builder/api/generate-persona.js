...
Return ONLY valid JSON (no code fences, no commentary):
{
  ...
  "cards": [ 2-4 scripted cards, same schema as: {"style":"note"|"chart"|"stat"|"image"|"question","title":"…","body":"…","trigger":"keyword"|"time"|"start","keywords":"…","atMinutes":0,"hideAfter":0,"owner":"featured"|"host"} — "owner" is WHOSE SCREEN the card appears on: the speaker who raises/asks that beat (a question card belongs to the asker; a chart belongs to whoever cites the numbers) ]
}
